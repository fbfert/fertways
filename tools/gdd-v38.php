...
/**
 * Gera o FERTWAYS GDD v38 (D-62, atualizado no D-141).
 *
 *     /usr/bin/php84 tools/gdd-v38.php > ../../FERTWAYS_GDD_v38_CONSOLIDADO.html
 *
 * Este arquivo é uma cópia evoluída de `gdd-v36.php` (que fica intocado, como o v35 ficou intocado
 * quando o v36 nasceu — D-62). Herda tudo o que estava atualizado até o D-101, e acrescenta o que
 * mudou desde então (D-102 a D-140, 39 decisões): o Depósito Local/Silo — 22º slot (D-105/106/108),
 * o Furgão fabricado pelo Ministério (D-109), manutenção de estruturas (D-112), Gestão de
 * Construções/Fila/Subsídios editáveis sem deploy (D-108/D-111/D-113), a **Federação inteira**
 * (núcleo, chat, apoio no cerco, missões cooperativas, antimonopólio, desconto entre aliados —
 * D-114 a D-121), o Ranking de Guerras (D-128), os **Leilões** — sistema desenhado do zero, sem
 * base no GDD (D-129, e a Fase 2 vendendo item da Endurance, D-136), os **Cargos Públicos** —
 * Repórter, Fiscal de Mercado, Auxiliar de Tesouro (D-130), o Tanque de Combustível travando
 * produção no teto (D-131), a **Loja de Peças da Endurance refeita por completo** — catálogo
 * dinâmico, efeitos que mexem no motor de verdade, Leilões vendendo item, manual dos benefícios
 * (D-132 a D-137), a demolição de estrutura de zona neutra (D-138), e as **missões narrativas da
 * Endurance** — 4 capítulos encadeados, o primeiro encadeamento do motor de Missões (D-140).
 *
 * ---
 *
...
<title>FERTWAYS — GDD v38 (consolidado)</title>
<style>
...
<header class="capa">
  <div class="env">
    <small>Game Design Document · versão 38 · consolidada</small>
    <h1>FERTWAYS</h1>
    <p>
      A base de produção do jogo. Este documento <b>substitui o v35</b> e, ao contrário dele,
      <b>não se contradiz</b>. É a segunda regeneração do v36 (D-62) — a primeira foi até o D-101;
      esta chega até o <b>D-140</b>, com <b>Federação</b> e <b>a Endurance</b> como frentes novas.
    </p>
...
<p>
  Das <b>140 decisões</b> já mescladas que este projeto registrou até hoje, boa parte existe
...
<p>
  O 22º slot, sozinho na última linha da colmeia — não muda a posição de nenhum dos 21 originais.
...
<footer>
  <div class="env">
    <p>
      <b>FERTWAYS — GDD v38.</b> Substitui o v36 (D-62), que substituiu o v35 — os dois ficam como
      registro histórico do que se pensava antes.
    </p>
    <p>
      ...
      as mesmas de onde o jogo lê — por <code>tools/gdd-v38.php</code>. O documento <b>não pode
      divergir do jogo</b>.
    </p>
    <p>
