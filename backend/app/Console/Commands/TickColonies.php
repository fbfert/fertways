...
class TickColonies extends Command
{
    ...
    public function handle(
        ...
        // Cargos Públicos, §14.2 (D-130) — mesmo salário diário do Conciliador, mesmo lugar do tick.
        $salariosCargos = $cargosCivicos->handle();
